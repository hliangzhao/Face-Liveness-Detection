%% obtain the HOOF features a frame of optical flow in REPLAY-ATTACK testing set and testing it.
addpath('./libsvm-3.19/matlab');
addpath('./HOOF');
load('HOOF_REPLAY_ATTACK_SVM_model.mat')
...
save HOOF_REPLAY_ATTACK_test_features.mat TestFeatureSet flagSet
...
save HOOF_REPLAY_ATTACK_SVM_model_test.mat DataCorrectRate CorrectRate