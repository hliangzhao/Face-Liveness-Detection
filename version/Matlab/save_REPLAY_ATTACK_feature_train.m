%% obtain the HOOF features a frame of optical flow in REPLAY-ATTACK tarining set and training it.
...
for IdxSubject = 1 : fileNo
    for IdxData = 1 : 8
        Name = ['./database/PRINT-ATTACK/train/' fileDirec{1, IdxData} 'client' fileIndex{IdxSubject} '_session01_' fileDirec{2, IdxData} '.mov'];
...
save HOOF_REPLAY_ATTACK_train_features.mat TrainFeatureSet TrainTruth
save HOOF_REPLAY_ATTACK_SVM_model.mat model TrainAccuracy